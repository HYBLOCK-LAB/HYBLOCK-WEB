  ...
  return (
    <div className="mx-auto max-w-xl space-y-3">
      <button
        ...
        className="flex w-full items-center justify-center gap-3 rounded-xl border border-monolith-outline-variant/30 bg-monolith-surface-low px-5 py-4 text-sm font-semibold text-monolith-on-surface transition-colors hover:bg-monolith-surface"
      >
