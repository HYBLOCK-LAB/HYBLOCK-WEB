...
CREATE TABLE IF NOT EXISTS attestation (
  ...
  CONSTRAINT fk_attestation_member
...
CREATE INDEX IF NOT EXISTS idx_attestation_member
  ON attestation(member_id);
...
CREATE INDEX IF NOT EXISTS idx_attestation_member_type
  ON attestation(member_id, attestation_type);
...
COMMENT ON COLUMN attestation.member_id IS '멤버 ID - member 테이블 참조';
